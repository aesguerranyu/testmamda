    ...
    <div className="container mx-auto max-w-7xl px-4 sm:px-5 lg:px-6 py-5">
          ...
          <div className="border border-gray-300 p-4 md:p-8 mb-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="grid grid-cols-3 md:flex gap-3 md:gap-4">
                ...
                <button
                  key={status}
                  className={`text-center cursor-pointer transition-transform hover:scale-105 p-2 rounded ${selectedStatus === status ? "bg-gray-100" : ""}`}
      ...
      <div className="mb-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <label
              className="block text-sm font-bold text-black uppercase mb-3"
              style={{
            ...
            <div className="flex flex-wrap gap-2">
              {statuses.map((status) => (
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium transition-all border cursor-pointer uppercase ${selectedStatus === status ? "bg-[#0C2788] text-white border-[#0C2788]" : "bg-gray-100 border-gray-200 hover:bg-gray-200"}`}
                  style={
            ...
            <div className="flex flex-wrap gap-2">
              {categories.map((category) => (
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium transition-all border cursor-pointer uppercase ${selectedCategory === category ? "bg-[#0C2788] text-white border-[#0C2788]" : "bg-gray-100 border-gray-200 hover:bg-gray-200"}`}
                  style={

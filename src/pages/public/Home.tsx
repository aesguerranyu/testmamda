        ...
        zIndex: 10
          ...
          <div className="text-center">
            ...
            height: "32px"
              ...
              <div className={`absolute ${trainVisible ? trainFromLeft ? "animate-[train-left-to-right_8s_linear_forwards]" : "animate-[train-right-to-left_8s_linear_forwards]" : "opacity-0"}`} style={{
              top: "0",
...
to New Yorkers<br /> to New Yorkers
      ...
      scrollMarginTop: "2rem"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-5 items-stretch" style={{
        gridAutoRows: "1fr"
      }}>

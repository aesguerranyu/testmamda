...
export default function AppointmentTracker() {
  ...
  return (
    <>
      <SEO
        title="Mamdani Administration Tracker | NYC Mayor Appointments"
        description="Track key appointments made by Mayor Zohran Mamdani as they are announced. See who's been appointed to cabinet positions, agency heads, and key administration roles."
        keywords="Zohran Mamdani appointments, NYC mayor cabinet, mayoral appointments, NYC administration, deputy mayors, city hall appointments"
        canonical="https://mamdanitracker.nyc/zohran-mamdani-appointment-tracker"
        ogType="article"
      />
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-5 lg:px-6 py-5">
        ...
        {!isLoading && appointments.length === 0 && (
          <div className="text-center py-12 bg-white border-2 border-gray-300">
            ...
            {sections.map((section) => (
              <div key={section}>
                ...
                <div className="border-b-2 border-[#0C2788] pb-2 mb-4">
                  <h2 className="font-bold text-black" style={{ fontSize: "24px" }}>
                    {section}
                  </h2>
                </div>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-gray-100 border-b-2 border-gray-200">
                        ...
                        <TableHead 
                          className="font-bold text-black uppercase tracking-wide hidden sm:table-cell"
                          style={{ fontSize: "12px", letterSpacing: "0.05em" }}
                        >
                          Former / Current Role
                        </TableHead>
                    ...
                    <TableBody>
                      {groupedAppointments[section].map((apt) => (
                        <TableRow 
                          key={apt.id} 
                        ...
                        >
                          ...
                          <TableCell 
                            className="text-gray-600 py-4 hidden sm:table-cell"
                            style={{ fontSize: "14px" }}
                          >
                            {apt.former_role || "—"}
                          </TableCell>

        ...
        <section className="mb-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-600 font-medium uppercase tracking-wide text-xs mb-2">What is a Promise?</p>
              <p className="text-gray-600 text-base leading-relaxed">
        ...
        <div className="flex flex-col gap-4">
          ...
          <section className="bg-white border-2 border-gray-300">
            <div className="bg-[#0C2788] px-4 md:px-5 py-4 flex items-center gap-3">
              ...
              <h2 className="font-bold text-white m-0" style={{
              fontSize: '20px'
            }}>
                <span className="hidden md:inline" style={{
                fontSize: '24px'
              }}>What's a "Promise"?</span>
            ...
            <div className="p-4 md:p-5">
              ...
              <ul className="list-none p-0 m-0 mb-4">
                {["Campaign policy platforms and manifestos", "Legislative proposals or co-sponsorships", "Public statements at hearings, press conferences, or official events", "Written positions in official publications or verified social media"].map((item, idx) => <li key={idx} className="flex items-start gap-3 mb-3">
                    <span className="shrink-0 flex items-center justify-center text-white font-bold bg-[#EE352E]" style={{
                  width: '2rem',
                  height: '2rem'
                }}>
                      {idx + 1}
          ...
          <section className="bg-white border-2 border-gray-300">
            ...
            <div className="p-4 md:p-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                status: "Not started",
                color: "#6B7280",
                desc: "No public action taken toward implementation"
              }, {
                status: "In progress",
                color: "#0039A6",
                desc: "Active steps underway (committee review, pilot programs, etc.)"
              }, {
                status: "Completed",
                color: "#00933C",
                desc: "Policy enacted through legislation, regulation, or program launch"
              }, {
                status: "Stalled",
                color: "#EE352E",
                desc: "Progress halted due to obstacles or lack of support"
              }].map(item => <div key={item.status} className="bg-white border-2 border-gray-300 p-4">
          ...
          <section className="bg-white border-2 border-gray-300">
            ...
            <div className="p-4 md:p-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                {["Official government documents", "Verified official statements", "Credible news reporting", "Public records & agency data"].map((source, idx) => <div key={idx}>

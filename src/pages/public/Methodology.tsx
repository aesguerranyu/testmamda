        ...
        <section className="mb-8">
          ...
          <div className="flex flex-col gap-8 max-w-4xl pl-4 md:pl-6">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed italic">Erwin is a web developer based with professional experience working for several U.S.-based web development companies. He specializes in PHP-based web development and the maintenance of large, content-driven platforms, including building special websites and applications for INQUIRER.net, the multimedia arm of the Philippine Daily Inquirer. His work sits at the intersection of web engineering, accessibility, and standards-compliant implementation, with a focus on building reliable, secure, and scalable web solutions. 


Erwin has hands-on experience in Linux-based environments, developing and troubleshooting server-side and front-end integrations, and supporting accessibility compliance initiatives aligned with Section 508 requirementsHis background includes working on complex systems that require close attention to performance, maintainability, and user experience. Outside of work, Erwin continues to deepen his technical expertise, keeps up with developments in web standards and accessibility, and enjoys thoughtful films, reading, and refining personal projects.  </p>
            </div>
          </div>
        </section>

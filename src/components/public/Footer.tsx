...
export function Footer() {
  return <footer className="text-white mt-auto border-t-4 border-white" style={{
    backgroundColor: '#394674'
      ...
      <div className="container mx-auto max-w-7xl px-3 sm:px-4 lg:px-5 py-5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
          ...
          <div>
            <h2 className="font-bold mb-3 text-white" style={{
            fontSize: '28px'
          }}>Mamdani Tracker</h2>
            <p className="text-white mb-3 leading-relaxed text-sm">
              Tracking Mayor Zohran Mamdani's promises and actions in New York City.
            </p>
            <a href="mailto:hello@mamdanitracker.nyc" className="text-white no-underline text-sm font-bold tracking-wide inline-block hover:opacity-70 transition-opacity" aria-label="Contact us via email at hello@mamdanitracker.nyc">
          ...
          <div>
            <nav aria-label="Footer navigation">
              ...
              <ul className="list-none p-0 m-0">
                <li className="mb-2">
                  <Link to="/promises" className="text-white no-underline text-sm block hover:opacity-70 transition-opacity">
                    Promises and Agenda
                  </Link>
                </li>
                <li className="mb-2">
                  <Link to="/first100days" className="text-white no-underline text-sm block hover:opacity-70 transition-opacity">
                    First 100 Days
                  </Link>
                </li>
                <li className="mb-2">
                  <Link to="/indicators" className="text-white no-underline text-sm block hover:opacity-70 transition-opacity">
                    NYC Performance Indicators
                  </Link>
                </li>
                <li className="mb-2">
                  <Link to="/methodology" className="text-white no-underline text-sm block hover:opacity-70 transition-opacity">
                    About
                  </Link>
                </li>
                <li className="mb-2">
                  <Link to="/membership" className="text-white no-underline text-sm block hover:opacity-70 transition-opacity">
                    Become a Member
                  </Link>
                </li>
              </ul>
        ...
        {/* Bottom Bar */}
        <div className="mt-4 md:mt-5 pt-4" style={{
        paddingBottom: '20px'
      }}>
          ...
          marginBottom: '20px'
            ...
            <div className="subway-train" style={{
            position: 'absolute',
            top: '5px',
            left: 0,
            zIndex: 2,
            ...
            animation: 'train-move 30s linear infinite'
              ...
              {/* 6-Car Subway Train */}
              <svg width="360" height="26" viewBox="0 0 360 26" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
              opacity: 0.6,
              display: 'block'
            }}>
                {/* Car 1 */}
